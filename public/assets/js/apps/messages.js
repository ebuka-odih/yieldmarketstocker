...
!function (NioApp, $) {
  ...
  var $toggle_info = $('.user-toggle'),
      $msg_profile = $('.nk-msg-user'),
      ...
      olay_profile = 'nk-msg-user-overlay',
      shown_profile = 'user-shown',
  ...
  NioApp.Message = function () {
    function msg_autohide() {
      if (NioApp.Win.width >= flat_break) {
        if (!$body.hasClass('msg-user-autohide')) $body.addClass('msg-user-autohide');
      } else {
        if ($body.hasClass('msg-user-autohide')) $body.removeClass('msg-user-autohide');
      }
    }
    ...
    function profile_trigger() {
      $toggle_info.on('click', function (e) {
        ...
        if (NioApp.Win.width >= flat_break) {
          if ($body.hasClass('msg-user-autohide')) {
            $body.removeClass('msg-user-autohide');
          } else if (NioApp.Win.width < info_break && !$(this).hasClass('active')) {
            $body.addClass('msg-user-autohide');
          }
        }
