                                ...
                                <ul class="uk-list uk-list-divider uk-margin-small-top">
                                    <li>
                                        <div class="uk-flex uk-flex-middle">
                                            <i class="fas fa-paper-plane fa-lg in-icon-wrap uk-margin-right"></i>
                                            <div>
                                                <h3 class="uk-margin-remove-bottom">35,817</h3>
                                    ...
                                    <li>
                                        <div class="uk-flex uk-flex-middle">
                                            <i class="fas fa-user-tie fa-lg in-icon-wrap uk-margin-right"></i>
                                            <div>
                                                <h3 class="uk-margin-remove-bottom">1,094,428</h3>
                                                <span class="uk-label uk-text-small uk-border-rounded">Investors engaged</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
