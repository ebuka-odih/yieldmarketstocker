            ...
            <div class="nk-content-body">
                <div class="page-dw wide-xs m-auto" id="pm-step-container"><div class="nk-pps-apps">
                        ...
                        <div class="nk-pps-title text-center">
                            ...
                            <p class="caption-text">You are about to deposit <strong class="text-dark">{{ $deposit->showBTCRate() }} BTC</strong> in your account.</p>
                        ...
                        <div class="nk-pps-data">
                            <ul class="nk-olist">
                                <li class="nk-olist-item">
                                    ...
                                    <div class="data"><span class="method"><em class="icon ni ni-wallet-fill"></em> <span>Crypto Payment (Bitcoin)</span></span></div>
                                </li>

                                <li class="nk-olist-item is-grouped">
                                    <div class="label lead-text">You will send</div>
                                    <div class="data"><span class="amount">{{ $deposit->showBTCRate() }} BTC</span></div>
                                </li>
                                <li class="nk-olist-item small is-grouped">
                                    <div class="label">Exchange rate</div>
                                    <div class="data fw-normal text-soft">
                                        <span class="amount">1 USD = {{ $deposit->BTCRate() }} BTC</span>
                                    </div>
                                </li>
                                ...
                                <li class="nk-olist-item small">
                                    ...
                                    <div class="data fw-normal text-soft">
                                        <span class="amount">{{ $deposit->showRate() }} EUR</span>
                                    </div>
                                </li>
                            ...
                            <div class="sub-text-sm">* Payment info (Bitcoin wallet) will available once you proceed.</div>
                        </div>
                        <div class="nk-pps-field form-action text-center">
                            <div class="nk-pps-action">
                                <a href="{{ route('user.showBTCInfo', $deposit->id) }}" class="btn btn-lg btn-block btn-primary"  data-url="{{ route('user.showBTCInfo', $deposit->id) }}">
                                    <span>Confirm &amp; Pay</span>
                                    <span class="spinner-border spinner-border-sm hide" role="status" aria-hidden="true"></span>
                                </a>
                            </div>
                            <div class="nk-pps-action pt-3">
                                <a href="{{ route('user.deposit') }}" class="btn btn-outline-danger btn-trans">Cancel Order</a>
                            </div>
                        </div>
                    </div>
                </div>
