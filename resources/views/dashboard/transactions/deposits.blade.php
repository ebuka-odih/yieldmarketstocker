            ...
            <div class="nk-content-body">
                ...
                <ul class="nk-nav nav nav-tabs">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link active" href="{{ route('user.deposits') }}">Deposit
...
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link" href="https://www.beckstocker.com/public/transactions?view=scheduled">--}}
                                ...
                                <div class="nk-odr-col">
                                    <div class="nk-odr-info">
                                        ...
                                        <div class="nk-odr-data">
                                            <div class="nk-odr-label ellipsis">{{ $item->transType() }}</div>
